  ...
  <section ref="sectionRef" class="matching-preview" :class="{ 'is-visible': isVisible }">
    <div class="container-main">
      ...
      <div class="matching-container">
        ...
        <div class="profile profile-left">
          <div class="profile-image">
            <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=400&h=400&fit=crop&crop=face" alt="Sophie" />
          </div>
        ...
        <div class="profile profile-right">
          <div class="profile-image">
            <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop&crop=face" alt="Thomas" />
          </div>
          <div class="profile-info">
      ...
      <p class="matching-tagline">
        Notre algorithme analyse <strong>16 dimensions de personnalité</strong> pour trouver votre match idéal.
      </p>
    </div>
  </section>
</template>
