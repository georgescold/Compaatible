...
function handleMouseLeave(e: MouseEvent): void {
  // Detect when mouse moves toward the top of the page (intent to leave)
  if (e.clientY <= 5 && !hasBeenShown.value && !checkIfAlreadyShown()) {
    showPopup()
  }
}
          ...
          <div class="popup-content">
            ...
            <ul class="popup-features">
              <li>
                ...
                Test de personnalité complet (16 dimensions)
              </li>
              <li>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3">
                  <polyline points="20 6 9 17 4 12"/>
                </svg>
                1 match ultra-compatible garanti
              </li>
              <li>
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3">
                  <polyline points="20 6 9 17 4 12"/>
